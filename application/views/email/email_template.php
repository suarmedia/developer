                        ...
                        <td style="text-align: center;">
                            <div style="height: 70px;width:100%;text-align: center;margin-bottom: 10px;">
                                <a href="<?php echo lang_base_url(); ?>">
                                    <img src="<?php echo get_logo_email($this->visual_settings_model->get_settings()); ?>" alt="" style="max-width: 180px;max-height: 70px;">
                                </a>
                            </div>
                        </td>
                    </tr>
                                    ...
                                    <td>
                                        <?php if (isset($link)): ?>
                                            <a href="<?php echo $link ?>" style="text-decoration: none !important;">
                                                <h1 style="text-decoration: none; font-size: 28px;line-height: 38px;font-weight: bold"><?php echo $title; ?></h1>
                                            </a>
                                        <?php else: ?>
                                            <h1 style="text-decoration: none; font-size: 28px;line-height: 38px;font-weight: bold"><?php echo $title; ?></h1>
                                        <?php endif; ?>
                    ...
                    <tr>
                        <td class="content-block" style="text-align: center;width: 100%;">
                            ...
                            <?php if (!empty($settings->google_url)) : ?>
                                <a href="<?php echo html_escape($settings->google_url); ?>" target="_blank" style="color: transparent;margin-right: 5px;">
                                    <img src="<?php echo base_url(); ?>assets/img/social-icons/googleplus.png" alt="" style="width: 28px; height: 28px;"/>
                                </a>
                            <?php endif; ?>
                        ...
                        <tr>
                            <td class="content-block">
                                <?php if (!empty($show_unsubscribe)): ?>
                                    <?php echo trans("dont_want_receive_emails"); ?> <a href="<?php echo base_url(); ?>unsubscribe?email=<?php echo $email; ?>"><?php echo trans("unsubscribe"); ?></a>.
                                <?php endif; ?>
                            </td>
                        </tr>
                    </table>
